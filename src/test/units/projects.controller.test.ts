...
describe('Manage projects', () => {
  test('should get projects - projects not do exist', async () => {
    const mockRequest: Partial<any> = { body: {}, user: { ...testingUser } };
  ...
  test('should add project - projects do not exist', async () => {
    ...
    const mockRequest: Partial<any> = { body: { ...testingProject }, user: { ...testingUser } };
    const mockReply: Partial<any> = {
      status: jest.fn().mockReturnThis(),
      statusCode: jest.fn(),
      send: jest.fn()
  ...
  test('should add projects - projects do exist', async () => {
    ...
    const mockRequest: Partial<any> = { body: { ...newProject }, user: { ...testingUser } };
    const mockReply: Partial<any> = {
      status: jest.fn().mockReturnThis(),
      statusCode: jest.fn(),
      send: jest.fn()
  ...
  test('should get project - projects do exist', async () => {
    const mockGetProjectsRequest: Partial<any> = { body: {}, user: { ...testingUser } };
    ...
    const mockRequest: Partial<any> = { body: {}, user: { ...testingUser }, params: { guid: dataCalledWith.guid } };
    const mockReply: Partial<any> = {
      status: jest.fn().mockReturnThis(),
      statusCode: jest.fn(),
      send: jest.fn()
  ...
  test('should not update project - project does not exist', async () => {
    const mockRequest: Partial<any> = { body: { ...testingProject }, user: { ...testingUser }, params: { guid: uuidv4() } };
    const mockReply: Partial<any> = {
      status: jest.fn().mockReturnThis(),
      statusCode: jest.fn(),
      send: jest.fn()
  ...
  test('should update project - project does exist', async () => {
    ...
    const mockRequest: Partial<any> = { body: { toUpdatePayload }, user: { ...testingUser }, params: { guid: project.guid } };
    const mockReply: Partial<any> = {
      status: jest.fn().mockReturnThis(),
      statusCode: jest.fn(),
      send: jest.fn()
