...
describe('Manage tasks', () =>{
    test('should not get tasks - tasks do not exist (project empty)', async ()=>{
      ...
      let mockRequest: Partial<any> = {body:{}, user:{...testingUser}, query:{projectGuid:testingProject.guid}};
    ...
    test('should add tasks - tasks do not exist', async ()=>{
      ...
      let mockRequest: Partial<any> = {body:{...addTaskPayload}, user:{...testingUser}, query:{projectGuid:testingProject.guid}};
      let mockReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
    ...
    test('should not update tasks - task does not exist', async ()=>{
      ...
      let mockRequest: Partial<any> = {body:{...editTaskPayload}, user:{...testingUser}, params:{guid:uuidv4()} };
      let mockReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
    ...
    test('should update tasks - task does exist', async ()=>{
      let mockGetTasksRequest: Partial<any> = {body:{}, user:{...testingUser}, query:{projectGuid:testingProject.guid}};
      let mockGetTasksReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
      };
      ...
      let mockRequest: Partial<any> = {body:{...editTaskPayload}, user:{...testingUser}, params:{guid:task.guid}, };
      let mockReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
    ...
    test('should not patch tasks status - task does not exist', async ()=>{
      ...
      let mockRequest: Partial<any> = {body:{...pacthPayload}, user:{...testingUser}, params:{guid:uuidv4()},};
      let mockReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
    ...
    test('should patch tasks status - task does exist', async ()=>{
      // Get project tasks using the first project in the array
      let mockGetProjectTasksRequest: Partial<any> = {body:{}, user:{...testingUser}, query:{projectGuid:testingProject.guid}};
      let mockGetProjectTasksReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
      };
      ...
      let mockRequest: Partial<any> = {body:{...pacthPayload}, user:{...testingUser}, params:{guid:task.guid}, query:{projectGuid:testingProject.guid}};
      let mockReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
    ...
    test('should delete tasks status - task does exist', async ()=>{
      ...
      let mockRequest: Partial<any> = {body:{...pacthPayload}, user:{...testingUser}, params:{guid:task.guid}, query:{projectGuid:testingUser.guid}};
      let mockReply: Partial<any> = {
        status: jest.fn().mockReturnThis(),
        statusCode: jest.fn(),
        send: jest.fn()
