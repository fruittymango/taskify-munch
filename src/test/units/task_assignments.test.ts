...
describe('Manage tasks assignments', () => {
    ...
    test('should not add one task assignments - task does not exist',async()=>{
        let mockRequest: Partial<any> = {body:{userId:1}, user:{userId:1}, params:{guid:uuidv4()},};
    ...
    test('should not add one task assignment - user does not exist',async()=>{
        let mockRequest: Partial<any> = {body:{userId:110}, user:{userId:1}, params:{guid:testTask.guid},};
        let mockReply: Partial<any> = {
            status: jest.fn().mockReturnThis(),
            statusCode: jest.fn(),
            send: jest.fn()
    ...
    test('should add one task assignments - task does exist',async ()=>{
        // Get project tasks 
        let mockAssignTaskRequest: Partial<any> = {body:{userId:1}, user:{...testingUser}, params:{guid:testTask.guid}};
        let mockAssignTasksReply: Partial<any> = {
            status: jest.fn().mockReturnThis(),
            statusCode: jest.fn(),
            send: jest.fn()
        };
    ...
    test('should not remove one task assignments - task does not exist',async ()=>{
        let mockRequest: Partial<any> = {body:{userId:2}, user:{userId:1}, params:{guid:uuidv4()},};
        let mockReply: Partial<any> = {
            status: jest.fn().mockReturnThis(),
            statusCode: jest.fn(),
            send: jest.fn()
    ...
    test('should not remove one task assignments - user does not exist',async ()=>{
        let mockRequest: Partial<any> = {body:{}, user:{userId:101}, params:{guid:testTask.guid},};
        let mockReply: Partial<any> = {
            status: jest.fn().mockReturnThis(),
            statusCode: jest.fn(),
            send: jest.fn()
    ...
    test('should remove one task assignments- user does exist',async()=>{
        let mockRequest: Partial<any> = {body:{userId:1}, user:{userId:1}, params:{guid:testTask.guid},};
        let mockReply: Partial<any> = {
            status: jest.fn().mockReturnThis(),
            statusCode: jest.fn(),
            send: jest.fn()
